...
export const metadata: Metadata = { title: "Hizmetler", description: "Kariyer danışmanlığı, psikolojik danışmanlık, kurumsal eğitimler ve seminerler." };
const services = [
  ...
  ["Psikolojik Danışmanlık", "Kendinizi daha iyi anlamak, zorlayıcı döngüleri fark etmek ve daha işlevsel seçimler yapabilmek için güvenli bir düşünme alanı.", ["Öz farkındalık", "Kaygı ve erteleme", "Karar verme", "Yaşam yönü"]],
