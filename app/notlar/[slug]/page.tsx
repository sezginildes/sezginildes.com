...
export default async function StudyNotePage({ params }: Props) {
  ...
  return <PageShell><article className="shell max-w-4xl py-14 sm:py-24">
    ...
    <div className="mt-12 rounded-3xl bg-[#efece6] p-8 sm:p-12">
      <h2 className="font-serif text-3xl text-[#17324f]">Çalışma notunu al</h2>
      <p className="mt-4 max-w-2xl leading-8 text-slate-700">Notu e-posta adresine almak için kayıt formuna geç. Formdaki bilgilendirmeyi okuyup tercihlerini sen belirleyebilirsin.</p>
      <a href={note.formUrl} target="_blank" rel="noopener noreferrer" className="mt-7 inline-block rounded-full bg-[#17324f] px-7 py-3.5 text-sm font-semibold text-white hover:bg-[#10283f]">Kayıt formuna git ↗</a>
    </div>
