  ...
  return (
    <footer className="bg-[#10283f] text-[#f8f7f4]">
      <div className="shell grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div><p className="text-xs font-bold tracking-[.16em] text-[#d9c49f]">KEŞFET</p><div className="mt-4 grid gap-2 text-sm text-slate-300"><Link href="/hakkimda">Hakkımda</Link><Link href="/psikolojik-danismanlik">Psikolojik Danışmanlık</Link><Link href="/kariyer-danismanligi">Kariyer Danışmanlığı</Link><Link href="/egitimler">Eğitim & Seminerler</Link><Link href="/blog">Blog</Link></div></div>
